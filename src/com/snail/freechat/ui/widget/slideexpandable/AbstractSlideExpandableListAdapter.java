...
public abstract class AbstractSlideExpandableListAdapter extends WrapperListAdapterImpl {
    ...
    private View lastOpenIcon = null;

    private ViewGroup lastOpenContentLayout = null;
    /**
    ...
    private void enableFor(final View button, final View target, final int position) {
        ...
        final ViewGroup parent = (ViewGroup) button.getParent().getParent().getParent();
        final ViewGroup buttonParent = (ViewGroup) button.getParent();
        final View icon = (View) buttonParent.getChildAt(0);
        final ViewGroup contentLayout = (ViewGroup) buttonParent.getChildAt(2);
                    ...
                    if (type == ExpandCollapseAnimation.EXPAND) {
                        if (lastOpenPosition != -1 && lastOpenPosition != position) {
                            if (lastOpen != null) {
                                ...
                                lastOpenIcon.setVisibility(View.VISIBLE);
                                lastOpenContentLayout.setVisibility(View.VISIBLE);
                            }
                        ...
                        lastOpenIcon = icon;
                        lastOpenContentLayout = contentLayout;

                        icon.setVisibility(View.INVISIBLE);
                        contentLayout.setVisibility(View.INVISIBLE);

                        if (null != expandCallBack) {
                            expandCallBack.expandListView(position, parent);
                        }
    ...
    public ExpandCallBack expandCallBack;
    ...
    public interface ExpandCallBack {
        ...
        void expandListView(int position, ViewGroup parent);
    }
}
